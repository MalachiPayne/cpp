...
public:
    ...
    ListNode(T nodeValue) // Constructor
    {
        value = nodeValue;
        next = nullptr;
    }
...
// ---------- appendNode appends a node containing the value passed into the newValue, to the end of the list ---------- //
template <class T>
void LinkedList<T>::appendNode(T newValue)
{
    ...
    // If there are no new nodes in the list make newNode the first node
    if (!head)
    {
        head = newNode;
    }
...
void LinkedList<T>::insertNode(T newValue)
{
    ...
    ListNode<T> *previousNode; // The previous node
    ...
    else // Otherwise, insert newNode
    {
        ...
        // If the new node is to be 1st in the list, insert it before all the other nodes
...
LinkedList<T>::~LinkedList()
{
    ...
    {
        // Save a pointer for the next node
